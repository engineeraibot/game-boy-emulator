        ...
        for (let x = 0; x < 160; x++) {
            ...
            if (spritesEnabled) {
                ...
                for (let sprite = 0; sprite < 40; sprite++) {
                    ...
                    let tileIndexSprite = this.mmu.read8bits(base + 2);
                    ...
                    const tileRowSprite = innerYSprite % 8;
                    const spriteTile = tileIndexSprite + Math.floor(innerYSprite / 8);
                    const spriteTileAddress = 0x8000 + spriteTile * 16;
                    const sByte1 = this.mmu.read8bits(spriteTileAddress + tileRowSprite * 2);
                    const sByte2 = this.mmu.read8bits(spriteTileAddress + tileRowSprite * 2 + 1);
